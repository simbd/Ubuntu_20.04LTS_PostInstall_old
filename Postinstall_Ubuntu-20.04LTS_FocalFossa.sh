...
then
	...
	f_action_exec "CA_VMWAREHORIZON" "wget https://download3.vmware.com/software/view/viewclients/CART21FQ2/VMware-Horizon-Client-2006-8.0.0-16522670.x64.bundle && chmod +x VMware*Horizon* && sudo env TERM=dumb VMWARE_EULAS_AGREED=yes ; sudo sh ./VMware-Horizon-Client*.bundle --console --set-setting vmware-horizon-virtual-printing tpEnable yes"
